...
class GTUOS{
    ...
    private:
       ...
       // 3 odev instructionları
       int fileCreate(const CPU8080& obje);
       int fileClose(const CPU8080& obje);
       int fileOpen(const CPU8080& obje);
    int fileRead(const CPU8080& obje);
    int fileWrite(const CPU8080& obje);
    int fileSeek(const CPU8080& obje);
    int DirRead(const CPU8080& obje);
